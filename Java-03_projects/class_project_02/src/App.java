...
public class App {
    ...
    // The bank system is initialized, passing the database instance to handle persistence (load/save)
    ...
    /**
     * Executes the main application logic: adding users and demonstrating functionality.
     */
    public void run() {
        System.out.println("\n==============================================");
        ...
        // This call adds the user to the list AND saves the entire list to database.txt.
